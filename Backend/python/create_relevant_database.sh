...
do
    ...
    # Cash Data
    python3 /scripts/Backend/python/create_sqldb.py -c /database_files/Binance/Actual/Balances/BTC_Balance.csv -n BTC_Balance
    python3 /scripts/Backend/python/create_sqldb.py -c /database_files/Binance/Actual/Balances/ETH_Balance.csv -n ETH_Balance
    python3 /scripts/Backend/python/create_sqldb.py -c /database_files/Binance/Actual/Balances/LTC_Balance.csv -n LTC_Balance
    python3 /scripts/Backend/python/create_sqldb.py -c /database_files/Binance/Actual/Balances/BNB_Balance.csv -n BNB_Balance
