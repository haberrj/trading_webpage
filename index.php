    ...
    <div class="hero-bg">
        ...
        <section class="cryptos">
            <section class="btc">
                ...
                <img id="btc_realtime" src="/database_files/BTC_Realtime.png" alt="Bitcoin price graph">
                <img id="btc_balance" src="/database_files/BTC_Balance.png" alt="Bitcoin balance graph">
            </section>
            <section class="eth">
                <div class="eth_title">
                    <h2>ETH</h2>
                ...
                <img id="eth_realtime" src="/database_files/ETH_Realtime.png" alt="Ethereum price graph">
                <img id="eth_balance" src="/database_files/ETH_Balance.png" alt="Ethereum balance graph">
            </section>
            <section class="ltc">
                <div class="ltc_title">
                    <h2>LTC</h2>
                ...
                <img id="ltc_realtime" src="/database_files/LTC_Realtime.png" alt="Litecoin price graph">
                <img id="ltc_balance" src="/database_files/LTC_Balance.png" alt="Litecoin balance graph">
            </section>
        </section>
    </div>
